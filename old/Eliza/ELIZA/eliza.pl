...
# why cant i
    ...
    "Why can't you?",
# are you
    "Wy are you interrested in whether or not I am?",
...
# father
  ...
  @key = (0,
    ...
    "computer","eliza","nokeyfound","mother","father") ;
